      ...
      >
        ...
        <div className="p-6 bg-secondary/50 rounded-2xl border border-base">
          <p className="text-secondary leading-relaxed">
            Мы в БиблиоТэка серьезно относимся к защите вашей конфиденциальности. Эта политика описывает,
        ...
        <section className="space-y-4">
          ...
          <div className="p-6 bg-secondary/30 rounded-xl border border-base">
            ...
            <div className="space-y-2">
              <p className="text-secondary">
                <span className="font-bold">Email:</span> privacy@biblioteka.ru
              </p>
              <p className="text-secondary">
        ...
        <div className="p-6 bg-accent/10 border border-accent/20 rounded-2xl">
          <p className="text-sm text-secondary text-center">
            Используя БиблиоТэка, вы соглашаетесь с нашей политикой конфиденциальности.
