      ...
      >
        ...
        <div className="p-6 bg-secondary/50 rounded-2xl border border-base">
          <p className="text-secondary leading-relaxed">
            Добро пожаловать в БиблиоТэка! Используя нашу платформу, вы соглашаетесь соблюдать
        ...
        <section className="space-y-4">
          ...
          <div className="p-6 bg-secondary/30 rounded-xl border border-base space-y-4">
            <p className="text-secondary">
              БиблиоТэка — это онлайн-платформа для чтения книг, обсуждения и обмена мнениями
              о литературе. Мы предоставляем доступ к библиотеке книг и создаем сообщество
              читателей.
            </p>
            <p className="text-secondary">
        ...
        <section className="space-y-4">
          ...
          <div className="p-6 bg-secondary/30 rounded-xl border border-base">
            <ul className="space-y-3 text-secondary">
              ...
              <li className="flex gap-3">
                <span className="text-green-500 font-bold">✓</span>
                <span>Создание личной библиотеки избранного</span>
              </li>
              <li className="flex gap-3">
                <span className="text-green-500 font-bold">✓</span>
        ...
        <section className="space-y-4">
          ...
          <div className="p-6 bg-secondary/30 rounded-xl border border-base space-y-4">
            <p className="text-secondary">
              БиблиоТэка предоставляется "как есть". Мы не несем ответственности за:
            </p>
            <ul className="space-y-2 text-secondary ml-4">
        ...
        <section className="space-y-4">
          ...
          <div className="p-6 bg-secondary/30 rounded-xl border border-base">
            <p className="text-secondary">
              ...
              электронной почте. Продолжая использовать БиблиоТэка после внесения изменений,
        ...
        <div className="p-6 bg-accent/10 border border-accent/20 rounded-2xl">
          <p className="text-sm text-secondary text-center">
            ...
            <a href="mailto:support@biblioteka.ru" className="text-accent font-bold ml-1">
